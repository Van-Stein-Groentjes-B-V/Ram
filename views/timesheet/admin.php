...
<div class="row">
    <div class="bs-callout bs-callout-primary col-lg-5">
        <h4><?php echo _('Timesheets: Admin'); ?></h4>
        <?php echo _('Here you can find the specific time sheets for specific people.'); ?>
    </div>
        <a href="<?php echo SITE_ROOT . 'timesheet' . '/'; ?>" type='button' class='btn btn-primary pull-right'><i class="fas fa-chevron-left"></i> <?php echo _('Go back'); ?></a>
</div>
        ...
        <div class="panel panel-danger ">
            ...
            <div class="panel-body">
                <form method="post" class="form-horizontal" role="form" onsubmit="return getSpecificStatsUser();">
                    <div class="form-check col-xs-6 col-md-3">
                        <label class="control-label" for="person"><?php echo _('Person:');?></label>
                        <div class="stop-to-large-dropdown">
                            <input type="number" class="form-control bedrijfpersoonpickerLazy hidden" name="person_id" id="person_id" data-id="person" value="<?php if(isset($oldValues['project_id'])){echo $oldValues['project_id'];}else{echo '-1';}?>"/>
                            <input name="project" type="text" class="form-control bedrijfpersoonpickerLazy searchOnKeyUp" data-callback="person" data-method="getContactPersonAll" data-target-id="person_id" data-control="api" autocomplete="off"/>
                            <div class="seng_standard_dropdown seng_dropdown_searchOnKeyUp" data-for="person">
                                <div class="info"></div>
                            </div>
                        </div>
                    </div>
                    <div class="form-check col-xs-6 col-md-3">
                        ...
                        <div id="projectPicker">
                            <div class="stop-to-large-dropdown">
                                ...
                                <input name="project" type="text" class="form-control bedrijfpersoonpickerLazy searchOnKeyUp" data-callback="project" data-method="getProjects" data-target-id="project_id" data-control="api" autocomplete="off"/>
                    ...
                    <div class="col-xs-6 col-md-3">
                        ...
                        <input type="date" class="form-control" data-date-format="yyyy-mm" id="savetime_timedate" name="timedate" value="<?php if(isset($oldValues['timedate'])){echo $oldValues['timedate'];}else{echo '';}?>">
                    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <!--<button class="btn btn-danger" name="deleteTime" value="x" style="width:23%;float:left;margin-left:2%;"><i class="fa fa-trash"></i> Delete</button>-->
                </form>
            </div>
        </div>
    </div>
